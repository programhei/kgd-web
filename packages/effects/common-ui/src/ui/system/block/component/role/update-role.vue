...
import {watch, ref, reactive, toRaw, h, watchEffect, onMounted} from "vue";
import {
...
const [ScaleModal, scaleModalApi] = useVbenModal({
  ...
  onOpened() {
    ...
    Object.assign(modelRef, {
      ...props.roleInfo,
      status: Number(props.roleInfo.status),
    })
  },
  onCancel() {
...
watch(() => props.checkedKeys,
  (v) => (
    checkedAllKeys.value = v
  ))
</script>

<template>
  <div class="space-y-4">
    <ScaleModal title="编辑角色" class="w-[550px] bg-background-deep">
