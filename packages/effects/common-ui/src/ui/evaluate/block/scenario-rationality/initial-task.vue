    ...
    <div class="w-full h-full flex gap-5">
      ...
      <Card class="h-full w-[40%]">
        <CardContent class="flex flex-col gap-0">
          ...
          <a-divider orientation="left">初始任务合理性</a-divider>
          <a-table
            :columns="columns"
          ...
          <a-divider orientation="left">想定任务合理性</a-divider>
          <a-table
            :columns="columns"
            :row-selection="rowSelection"
            :data-source="datasource"
          ...
          <a-divider orientation="left">初始友机数量合理性</a-divider>
          <a-table
            :columns="columns"
            :row-selection="rowSelection"
            :data-source="datasource"
          ...
          <a-divider orientation="left">挂载数量合理性</a-divider>
          <a-table
            :columns="columns"
            :row-selection="rowSelection"
            :data-source="datasource"
