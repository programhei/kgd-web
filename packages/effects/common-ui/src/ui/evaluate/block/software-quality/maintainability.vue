...
const tableData = ref([])
// 定义数据表格列
const columns_time_response = ref([
  {
    title: '编号',
    dataIndex: 'key',
    key: 'key',
...
const columns_resource_utilization = ref([
  {
    title: '编号',
    dataIndex: 'key',
    key: 'key',
    ...
    <div class="w-full h-full flex gap-5">
      ...
      <Card class="h-full w-1/3 ">
        <CardContent class="flex flex-col gap-0">
          ...
          <a-divider orientation="left">代码注释率</a-divider>
          <a-table
            :columns="columns_time_response"
            :data-source="datasource"
            bordered
            size="small"
            :pagination="false"
          ...
          <a-divider orientation="left">代码规范率</a-divider>
          <a-table
            :columns="columns_resource_utilization"
            :data-source="datasource"
            bordered
            size="small"
            :pagination="false"
