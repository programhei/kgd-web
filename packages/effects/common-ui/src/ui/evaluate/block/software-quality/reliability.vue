...
// 定义数据表格列
const columns_standardization = ref([
  {
    title: '编号',
    dataIndex: 'key',
    key: 'key',
    ...
    <div class="w-full h-full flex gap-5">
      ...
      <Card class="h-full w-1/3 ">
        <CardContent class="flex flex-col gap-0">
          ...
          <a-divider orientation="left">连续运行时间</a-divider>
          <a-table
            :columns="columns_annotation"
            :data-source="datasource"
            bordered
            size="small"
            :pagination="false"
          ...
          <a-divider orientation="left">代码容错率</a-divider>
          <a-table
            :columns="columns_standardization"
            :data-source="datasource"
            bordered
            size="small"
            :pagination="false"
